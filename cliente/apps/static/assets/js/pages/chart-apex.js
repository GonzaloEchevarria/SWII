    ...
    setTimeout(function() {
        $(function() {
            var options = {
                ...
                series: [{
                    name: "Body Fat",
                    data: [10, 41, 35, 51, 49, 62, 69, 87, 54]
                }],
                title: {
                    text: '',
                    align: 'left'
        ...
        $(function() {
            var options = {
                ...
                colors: ["#FFB64D", "#FF5370", "#FFB64D", "#FF5370"],
                fill: {
                    type: "gradient",
                    gradient: {
                        shade: 'light'
                ...
                series: [{
                        name: "Breast Goal",
                        data: [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 31]
                    },
                    {
                        name: "Hip Goal",
                        data: [60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 61]
                    },
                    {
                        name: "Breast Circumference",
        ...
        $(function() {
            var options = {
                ...
                series: [76, 67, 61, 90],
                labels: ['Hip', 'Waist', 'Left Leg', 'Right Leg'],
                legend: {
                    show: true,
                    floating: true,
                    fontSize: '16px',
        ...
        $(function() {
            var options = {
                ...
                labels: ['Hip', 'Right Arm', 'Left Arm', 'Waist', 'Chest', 'Left Leg', 'Right Leg']
            }
            var chart = new ApexCharts(
                document.querySelector("#radar-chart-0"),
                options
            );
            chart.render();
            function update() {
